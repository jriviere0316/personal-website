  ...
  render() {
    return (
        <div id='AboutMeDiv'>
            ...
            <hr/>
            <p class="aboutMe">I'm a Musician turned Software Developer with a passion for detail, utility, & aesthetic.</p>
            <p class="aboutMe">I love working with people & technology to produce artful, innovative, & functional content/creations.</p>
            <p id='lastaboutme'class="aboutMe">When I'm not coding you can find me:</p>
